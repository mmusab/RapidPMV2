...
export class LoginScreenComponent{
  ...
  rerouting(){
    ...
    if(this.auth.currentUser.authorized == "True"){
      ...
      // this.httpClient.get('http://192.168.1.15:5002/login/' + this.userEmail + '/' + this.userPassword).toPromise().then(message => {
  ...
  onregister(){
    // this.resetErrors();
    var url = "";
    if(this.userEmail){url = 'http://192.168.1.15:5002/login/' + this.userEmail + '/none'}
    else{url = 'http://192.168.1.15:5002/login/none/none'}
