...
export class SignupScreenComponent implements OnInit, ComponentCanDeactivate{
  ...
  ngOnInit() {
    ...
    this.sub = this.route.params.subscribe(params => {
      ...
      if(this.signupCompId != "id"){
        ...
        this.http.get('http://192.168.1.15:5002/getAdmin/' + this.signupCompId).subscribe((response)=>{
      ...
      this.http.get('http://192.168.1.15:5002/getCompany/' + this.signupCompId).subscribe((response)=>{
        this.temp = response as JSON;
        console.log(this.temp[0])
  ...
  onSignup(content:any){
    ...
    if(this.signupCompId == "id"){
    this.http.get('http://192.168.1.15:5002/emailVerification/' + this.customerInfo.cust.email).subscribe((response)=>{
        ...
        this.http.post('http://192.168.1.15:5002/company', this.companyInfo.comp).subscribe((response)=>{
      ...
      this.http.post('http://192.168.1.15:5002/user', this.customerInfo.cust).subscribe((response)=>{
  ...
  async open(content:any, otp:any) {
    ...
    this.modalService.open(content, {ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
      ...
      if(this.OTP != otp){
        ...
        this.http.post('http://192.168.1.15:5002/company', this.companyInfo.comp).subscribe(async (response)=>{
        this.signupCompId = (response as any)['message'];
        // this.dataService.adminId = this.signupCompId;
        this.customerInfo.cust["company_id"] = this.signupCompId;
        this.customerInfo.cust["company_role"] = "Admin";
