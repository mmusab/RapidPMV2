...
export class ProjectContentComponent implements OnInit {
      ...
      ngOnInit() {
          ...
          this.http.get('http://192.168.18.81:5002/getProject/' + this.projectId).subscribe((response)=>{
            ...
            this.http.get('http://192.168.18.81:5002/getHeirarchyList').subscribe((response)=>{
              ...
              this.http.get('http://192.168.18.81:5002/getContainers/' + this.selectedHeirarchyId + '/' + this.projectId).subscribe((response)=>{
                this.temp = response as JSON;
                this.containerList = []
              ...
              this.http.get('http://192.168.18.81:5002/getprojectTree/' + this.projectId + '/' + this.selectedHeirarchyId).subscribe((response)=>{
                this.files = response as TreeNode[];
                console.log(this.files)
              });
            });
            this.http.get('http://192.168.18.81:5002/getCompany/' + this.temp[0]["company_id"]).subscribe((response)=>{
              this.temp = response as JSON;
    ...
    move(pCont: string,cont: any){
      if(cont['id'] != pCont.split('-')[0]){
        if(cont['artefact_type'] == ""){
          this.http.get('http://192.168.18.81:5002/moveContainer/' + cont['id'] + "/container/" + pCont.split('-')[0] + "/" + this.selectedHeirarchyId).subscribe((response)=>{
          // location.reload()
          ...
          this.http.get('http://192.168.18.81:5002/moveContainer/' + cont['id'] + "/artefact/" + pCont.split('-')[0] + "/" + this.selectedHeirarchyId).subscribe((response)=>{
          // location.reload()
          this.router.navigate(['/app-project-content', this.projectId, this.userId,this.selectedHeirarchyId]);
          location.reload()
          });
    ...
    copy(pCont: string,cont: any){
      if(cont['id'] != pCont.split('-')[0]){
        if(cont['artefact_type'] == ""){
          this.http.get('http://192.168.18.81:5002/copyContainer/' + cont['id'] + "/container/" + pCont.split('-')[0]).subscribe((response)=>{
          location.reload()
        });
        }
        else{
          this.http.get('http://192.168.18.81:5002/copyContainer/' + cont['id'] + "/artefact/" + pCont.split('-')[0]).subscribe((response)=>{
          location.reload()
          });
        }
      }
    ...
    delete(cont: any){
      if(cont['artefact_type'] == ""){
        this.http.get('http://192.168.18.81:5002/deleteContainer/' + cont['id'] + "/container").subscribe((response)=>{
        ...
        this.http.get('http://192.168.18.81:5002/deleteContainer/' + cont['id'] + "/artefact").subscribe((response)=>{
        location.reload()
        });
      }
    }
    ...
    openArtefact(row: string | number){
      ...
      this.http.get('http://192.168.18.81:5002/openArtefact/' + row + '/default').subscribe((response)=>{
        this.temp = response as JSON;
    ...
    open(content:any, row:any) {
      ...
      this.modalService.open(content, {ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
        ...
        // console.log(row)
        // console.log(this.selectedHeirarchyId)
        this.http.get('http://192.168.18.81:5002/addContainer/' + this.newContainerName + "/" + row + "/" + this.projectId + "/" + this.selectedHeirarchyId).subscribe((response)=>{
        location.reload()
      });
      }, (reason) => {
    ...
    heirarchy(content:any) {
      ...
      this.modalService.open(content, {ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
        ...
        this.http.get('http://192.168.18.81:5002/addHeirarchy/' + this.newHeirarchyName).subscribe((response)=>{
    ...
    editContainer(content:any, row:any) {
      console.log("in open content")
      this.http.get('http://192.168.18.81:5002/getContainer/' + row).subscribe((response)=>{
              this.temp = response as JSON;
      ...
      this.modalService.open(content, {ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
        ...
        if(this.newContainerName != ""){
          this.http.get('http://192.168.18.81:5002/updateContainer/' + this.newContainerName + "/" + row).subscribe((response)=>{
    ...
    // addHeirarchy(){
    //   this.http.get('http://192.168.18.81:5002/addHeirarchy').subscribe((response)=>{
    //     location.reload()
    //   });
    // }
  ...
  goToProjects(){
    this.http.get('http://192.168.18.81:5002/getAdmin/' + this.companyId).subscribe((response)=>{
      this.temp = response as JSON;
